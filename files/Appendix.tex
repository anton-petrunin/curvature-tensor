...
We can assume that $b_i(x)$ points in the principal directions of $L_x$ for $i<m$.
...
For the first part of the observation, it remains to observe that the functions $a=\psi(\widetilde\dist_{p_1,r},\zz\dots,\widetilde\dist_{p_n,r})$ and $b=\chi(\widetilde\dist_{p_1,r},\zz\dots,\widetilde\dist_{p_n,r})$ are semiconcave.

...
We can assume that $b_i(x)$ point in the principle directions of $L_x$ for $i<m$.
...
Therefore we can say that $f$ is DC if and only if it can be presented locally as a difference of two semiconcave functions. 

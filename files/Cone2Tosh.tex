...
It is straightforward to check that this definition is $\vol^k$-almost-everywhere independent of the choice of $s$.
...
By the theorem of Artem Nepechiy \cite{Nepechiy},
...
Let $v_n$ and $w_n$ be sequences of uniformly bounded, continuous vector fields on $M_n$.
...
Since $G_n\rightharpoonup 0$, we get that the curvature measure of level sets of $f_n$ weakly converges to the curvature of $\Cone(\theta)$.
It follows that 
